...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UtilCurriculums.job_title'
        db.delete_column('util_curriculums', 'job_title_id')


    def backwards(self, orm):
        # Adding field 'UtilCurriculums.job_title'
        db.add_column('util_curriculums', 'job_title',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['utility.UtilJobTitles']),
                      keep_default=False)
