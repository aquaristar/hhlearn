...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UtilCurriculums.user_notes'
        db.add_column('util_curriculums', 'user_notes',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UtilCurriculums.user_notes'
        db.delete_column('util_curriculums', 'user_notes')
    ...
    models = {
        ...
        u'utility.utilcurriculums': {
            ...
            'last_course_page': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
