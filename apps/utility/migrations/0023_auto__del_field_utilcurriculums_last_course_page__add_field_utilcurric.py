...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UtilCurriculums.last_course_page'
        db.delete_column('util_curriculums', 'last_course_page')

        # Adding field 'UtilCurriculums.resume_from_page'
        db.add_column('util_curriculums', 'resume_from_page',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UtilCurriculums.last_course_page'
        db.add_column('util_curriculums', 'last_course_page',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'UtilCurriculums.resume_from_page'
        db.delete_column('util_curriculums', 'resume_from_page')
    ...
    models = {
        ...
        u'utility.utilcurriculums': {
            ...
            'resume_from_page': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'user_notes': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
