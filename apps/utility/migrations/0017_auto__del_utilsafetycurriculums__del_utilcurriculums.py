...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'UtilSafetyCurriculums'
        db.delete_table('util_safety_curriculums')

        # Deleting model 'UtilCurriculums'
        db.delete_table('util_curriculums')

        # Removing M2M table for field safety_curriculums on 'UtilJobTitles'
        db.delete_table(db.shorten_name('util_job_titles_safety_curriculums'))

        # Removing M2M table for field curriculums on 'UtilJobTitles'
        db.delete_table(db.shorten_name('util_job_titles_curriculums'))


    def backwards(self, orm):
        # Adding model 'UtilSafetyCurriculums'
        db.create_table('util_safety_curriculums', (
            ...
            ('month_assigned', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal(u'utility', ['UtilSafetyCurriculums'])

        # Adding model 'UtilCurriculums'
        db.create_table('util_curriculums', (
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.CoreCourses'])),
        ...
        # Adding M2M table for field safety_curriculums on 'UtilJobTitles'
        m2m_table_name = db.shorten_name('util_job_titles_safety_curriculums')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('utiljobtitles', models.ForeignKey(orm[u'utility.utiljobtitles'], null=False)),
            ('utilsafetycurriculums', models.ForeignKey(orm[u'utility.utilsafetycurriculums'], null=False))
        ))
        db.create_unique(m2m_table_name, ['utiljobtitles_id', 'utilsafetycurriculums_id'])

        # Adding M2M table for field curriculums on 'UtilJobTitles'
        m2m_table_name = db.shorten_name('util_job_titles_curriculums')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('utiljobtitles', models.ForeignKey(orm[u'utility.utiljobtitles'], null=False)),
            ('utilcurriculums', models.ForeignKey(orm[u'utility.utilcurriculums'], null=False))
        ))
        db.create_unique(m2m_table_name, ['utiljobtitles_id', 'utilcurriculums_id'])
