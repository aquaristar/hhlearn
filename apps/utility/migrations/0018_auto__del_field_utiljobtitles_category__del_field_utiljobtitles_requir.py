...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UtilJobTitles.category'
        db.delete_column('util_job_titles', 'category_id')

        # Deleting field 'UtilJobTitles.requires_license'
        db.delete_column('util_job_titles', 'requires_license_id')

        # Deleting field 'UtilJobTitles.description'
        db.delete_column('util_job_titles', 'description')

        # Deleting field 'UtilJobTitles.short_code'
        db.delete_column('util_job_titles', 'short_code')

        # Deleting field 'UtilJobTitles.flsa_status'
        db.delete_column('util_job_titles', 'flsa_status_id')

        # Deleting field 'UtilJobTitles.exposure_to_TB'
        db.delete_column('util_job_titles', 'exposure_to_TB_id')

        # Deleting field 'UtilJobTitles.name_possessive'
        db.delete_column('util_job_titles', 'name_possessive')

        # Deleting field 'UtilJobTitles.name'
        db.delete_column('util_job_titles', 'name')

        # Deleting field 'UtilJobTitles.is_active'
        db.delete_column('util_job_titles', 'is_active')

        # Deleting field 'UtilJobTitles.exposure_to_chemicals'
        db.delete_column('util_job_titles', 'exposure_to_chemicals_id')

        # Deleting field 'UtilJobTitles.on_call'
        db.delete_column('util_job_titles', 'on_call_id')

        # Deleting field 'UtilJobTitles.patient_file_access'
        db.delete_column('util_job_titles', 'patient_file_access_id')

        # Deleting field 'UtilJobTitles.all_occupational_exposure'
        db.delete_column('util_job_titles', 'all_occupational_exposure_id')

        # Deleting field 'UtilJobTitles.cpr'
        db.delete_column('util_job_titles', 'cpr_id')

        # Deleting field 'UtilJobTitles.some_occupational_exposure'
        db.delete_column('util_job_titles', 'some_occupational_exposure_id')

        # Deleting field 'UtilJobTitles.exposure_to_BBP'
        db.delete_column('util_job_titles', 'exposure_to_BBP_id')


    def backwards(self, orm):
        # Adding field 'UtilJobTitles.category'
        db.add_column('util_job_titles', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='util_job_title_category', null=True, to=orm['utility.UtilJobCategories']),
                      keep_default=False)

        # Adding field 'UtilJobTitles.requires_license'
        db.add_column('util_job_titles', 'requires_license',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='util_job_title_requires_license', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'UtilJobTitles.description'
        db.add_column('util_job_titles', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'UtilJobTitles.short_code'
        db.add_column('util_job_titles', 'short_code',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'UtilJobTitles.flsa_status'
        db.add_column('util_job_titles', 'flsa_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='util_job_title_flsa_status', null=True, to=orm['utility.UtilFlsaStatus']),
                      keep_default=False)

        # Adding field 'UtilJobTitles.exposure_to_TB'
        db.add_column('util_job_titles', 'exposure_to_TB',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='util_job_title_exposure_to_TB', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'UtilJobTitles.name_possessive'
        db.add_column('util_job_titles', 'name_possessive',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'UtilJobTitles.name'
        db.add_column('util_job_titles', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'UtilJobTitles.is_active'
        db.add_column('util_job_titles', 'is_active',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UtilJobTitles.exposure_to_chemicals'
        db.add_column('util_job_titles', 'exposure_to_chemicals',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='util_job_title_exposure_to_chemicals', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'UtilJobTitles.on_call'
        db.add_column('util_job_titles', 'on_call',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='util_job_title_on_call', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'UtilJobTitles.patient_file_access'
        db.add_column('util_job_titles', 'patient_file_access',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='util_job_title_patient_file_access', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'UtilJobTitles.all_occupational_exposure'
        db.add_column('util_job_titles', 'all_occupational_exposure',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='util_job_title_all_occupational_exposure', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'UtilJobTitles.cpr'
        db.add_column('util_job_titles', 'cpr',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='util_job_title_cpr', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'UtilJobTitles.some_occupational_exposure'
        db.add_column('util_job_titles', 'some_occupational_exposure',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='util_job_title_some_occupational_exposure', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'UtilJobTitles.exposure_to_BBP'
        db.add_column('util_job_titles', 'exposure_to_BBP',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='util_job_title_exposure_to_BBP', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)
