...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UtilCurriculums.is_active'
        db.add_column('util_curriculums', 'is_active',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UtilCurriculums.is_active'
        db.delete_column('util_curriculums', 'is_active')
