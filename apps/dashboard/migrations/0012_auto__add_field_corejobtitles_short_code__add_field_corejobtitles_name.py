...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoreJobTitles.short_code'
        db.add_column('core_job_titles', 'short_code',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'CoreJobTitles.name'
        db.add_column('core_job_titles', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'CoreJobTitles.name_possessive'
        db.add_column('core_job_titles', 'name_possessive',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'CoreJobTitles.name_custom'
        db.add_column('core_job_titles', 'name_custom',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'CoreJobTitles.name_custom_possessive'
        db.add_column('core_job_titles', 'name_custom_possessive',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'CoreJobTitles.description'
        db.add_column('core_job_titles', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'CoreJobTitles.category'
        db.add_column('core_job_titles', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_category', null=True, to=orm['utility.UtilJobCategories']),
                      keep_default=False)

        # Adding field 'CoreJobTitles.patient_file_access'
        db.add_column('core_job_titles', 'patient_file_access',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_patient_file_access', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'CoreJobTitles.exposure_to_chemicals'
        db.add_column('core_job_titles', 'exposure_to_chemicals',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_exposure_to_chemicals', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'CoreJobTitles.exposure_to_BBP'
        db.add_column('core_job_titles', 'exposure_to_BBP',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_exposure_to_BBP', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'CoreJobTitles.exposure_to_TB'
        db.add_column('core_job_titles', 'exposure_to_TB',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_exposure_to_TB', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'CoreJobTitles.requires_license'
        db.add_column('core_job_titles', 'requires_license',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_requires_license', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'CoreJobTitles.cpr'
        db.add_column('core_job_titles', 'cpr',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_cpr', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'CoreJobTitles.on_call'
        db.add_column('core_job_titles', 'on_call',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_on_call', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'CoreJobTitles.flsa_status'
        db.add_column('core_job_titles', 'flsa_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_flsa_status', null=True, to=orm['utility.UtilFlsaStatus']),
                      keep_default=False)

        # Adding field 'CoreJobTitles.is_custom'
        db.add_column('core_job_titles', 'is_custom',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_is_custom', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'CoreJobTitles.all_occupational_exposure'
        db.add_column('core_job_titles', 'all_occupational_exposure',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_all_occupational_exposure', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)

        # Adding field 'CoreJobTitles.some_occupational_exposure'
        db.add_column('core_job_titles', 'some_occupational_exposure',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_title_some_occupational_exposure', to_field='value', null=True, to=orm['utility.UtilYesorNo']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'CoreJobTitles.short_code'
        db.delete_column('core_job_titles', 'short_code')

        # Deleting field 'CoreJobTitles.name'
        db.delete_column('core_job_titles', 'name')

        # Deleting field 'CoreJobTitles.name_possessive'
        db.delete_column('core_job_titles', 'name_possessive')

        # Deleting field 'CoreJobTitles.name_custom'
        db.delete_column('core_job_titles', 'name_custom')

        # Deleting field 'CoreJobTitles.name_custom_possessive'
        db.delete_column('core_job_titles', 'name_custom_possessive')

        # Deleting field 'CoreJobTitles.description'
        db.delete_column('core_job_titles', 'description')

        # Deleting field 'CoreJobTitles.category'
        db.delete_column('core_job_titles', 'category_id')

        # Deleting field 'CoreJobTitles.patient_file_access'
        db.delete_column('core_job_titles', 'patient_file_access_id')

        # Deleting field 'CoreJobTitles.exposure_to_chemicals'
        db.delete_column('core_job_titles', 'exposure_to_chemicals_id')

        # Deleting field 'CoreJobTitles.exposure_to_BBP'
        db.delete_column('core_job_titles', 'exposure_to_BBP_id')

        # Deleting field 'CoreJobTitles.exposure_to_TB'
        db.delete_column('core_job_titles', 'exposure_to_TB_id')

        # Deleting field 'CoreJobTitles.requires_license'
        db.delete_column('core_job_titles', 'requires_license_id')

        # Deleting field 'CoreJobTitles.cpr'
        db.delete_column('core_job_titles', 'cpr_id')

        # Deleting field 'CoreJobTitles.on_call'
        db.delete_column('core_job_titles', 'on_call_id')

        # Deleting field 'CoreJobTitles.flsa_status'
        db.delete_column('core_job_titles', 'flsa_status_id')

        # Deleting field 'CoreJobTitles.is_custom'
        db.delete_column('core_job_titles', 'is_custom_id')

        # Deleting field 'CoreJobTitles.all_occupational_exposure'
        db.delete_column('core_job_titles', 'all_occupational_exposure_id')

        # Deleting field 'CoreJobTitles.some_occupational_exposure'
        db.delete_column('core_job_titles', 'some_occupational_exposure_id')
    ...
    models = {
        ...
        u'dashboard.corejobtitles': {
            ...
            'curriculums': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'core_job_title_curriculums'", 'symmetrical': 'False', 'to': u"orm['dashboard.CoreCurriculums']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
        ...
        u'dashboard.coreorganizations': {
            ...
            'curriculums': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'core_organization_curriculums'", 'symmetrical': 'False', 'to': u"orm['dashboard.CoreCurriculums']"}),
        ...
        u'dashboard.coreuserprofiles': {
            ...
            'curriculums': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'core_user_profile_curriculums'", 'symmetrical': 'False', 'to': u"orm['dashboard.CoreCurriculums']"}),
