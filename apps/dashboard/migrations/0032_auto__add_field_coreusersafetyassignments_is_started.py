...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoreUserSafetyAssignments.is_started'
        db.add_column('core_user_safety_assignments', 'is_started',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CoreUserSafetyAssignments.is_started'
        db.delete_column('core_user_safety_assignments', 'is_started')
