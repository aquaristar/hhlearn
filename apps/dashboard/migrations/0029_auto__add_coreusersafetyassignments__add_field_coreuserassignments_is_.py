...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CoreUserSafetyAssignments'
        db.create_table('core_user_safety_assignments', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.CoreUserProfiles'])),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.CoreCourses'])),
            ('date_assigned', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('due_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('date_completed', self.gf('django.db.models.fields.DateField')(null=True)),
            ('last_started', self.gf('django.db.models.fields.DateField')(null=True)),
            ('resume_from_page', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('user_notes', self.gf('django.db.models.fields.TextField')(null=True)),
            ('is_completed', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'dashboard', ['CoreUserSafetyAssignments'])

        # Adding field 'CoreUserAssignments.is_started'
        db.add_column('core_user_assignments', 'is_started',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CoreUserSafetyAssignments'
        db.delete_table('core_user_safety_assignments')

        # Deleting field 'CoreUserAssignments.is_started'
        db.delete_column('core_user_assignments', 'is_started')
    ...
    models = {
        ...
        u'dashboard.corecurriculums': {
            ...
            'resume_from_page': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
        ...
        u'dashboard.coreuserassignments': {
            'Meta': {'object_name': 'CoreUserAssignments', 'db_table': "'core_user_assignments'"},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dashboard.CoreCourses']"}),
            'date_assigned': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_completed': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            ...
            'is_active': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'is_completed': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'is_started': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'last_started': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'resume_from_page': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'user_notes': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dashboard.CoreUserProfiles']"})
        },
        ...
        u'dashboard.coreusersafetyassignments': {
            'Meta': {'object_name': 'CoreUserSafetyAssignments', 'db_table': "'core_user_safety_assignments'"},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dashboard.CoreCourses']"}),
            'date_assigned': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_completed': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'due_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
