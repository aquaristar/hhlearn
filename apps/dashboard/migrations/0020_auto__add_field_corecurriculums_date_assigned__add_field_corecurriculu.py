...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoreCurriculums.date_assigned'
        db.add_column('core_curriculums', 'date_assigned',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 6, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'CoreCurriculums.date_completed'
        db.add_column('core_curriculums', 'date_completed',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'CoreCurriculums.last_started'
        db.add_column('core_curriculums', 'last_started',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'CoreCurriculums.is_completed'
        db.add_column('core_curriculums', 'is_completed',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CoreCurriculums.date_assigned'
        db.delete_column('core_curriculums', 'date_assigned')

        # Deleting field 'CoreCurriculums.date_completed'
        db.delete_column('core_curriculums', 'date_completed')

        # Deleting field 'CoreCurriculums.last_started'
        db.delete_column('core_curriculums', 'last_started')

        # Deleting field 'CoreCurriculums.is_completed'
        db.delete_column('core_curriculums', 'is_completed')
    ...
    models = {
        ...
        u'dashboard.corejobtitles': {
            ...
            'safety_curriculums': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'core_job_title_safety_curriculums'", 'symmetrical': 'False', 'to': u"orm['dashboard.CoreSafetyCurriculums']"}),
            'short_code': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
        ...
        u'dashboard.coresafetycurriculums': {
            'Meta': {'object_name': 'CoreSafetyCurriculums', 'db_table': "'core_safety_curriculums'"},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dashboard.CoreCourses']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
