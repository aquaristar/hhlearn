...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CoreCurriculums.user_notes'
        db.add_column('core_curriculums', 'user_notes',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CoreCurriculums.user_notes'
        db.delete_column('core_curriculums', 'user_notes')
