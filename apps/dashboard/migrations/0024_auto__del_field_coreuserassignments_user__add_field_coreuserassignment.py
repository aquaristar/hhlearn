...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CoreUserAssignments.user'
        db.delete_column('core_user_assignments', 'user_id')

        # Adding field 'CoreUserAssignments.user_profile'
        db.add_column('core_user_assignments', 'user_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 6, 29, 0, 0), to=orm['dashboard.CoreUserProfiles']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CoreUserAssignments.user'
        db.add_column('core_user_assignments', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'CoreUserAssignments.user_profile'
        db.delete_column('core_user_assignments', 'user_profile_id')
