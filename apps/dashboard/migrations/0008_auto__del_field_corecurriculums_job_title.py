...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CoreCurriculums.job_title'
        db.delete_column('core_curriculums', 'job_title_id')


    def backwards(self, orm):
        # Adding field 'CoreCurriculums.job_title'
        db.add_column('core_curriculums', 'job_title',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dashboard.CoreJobTitles']),
                      keep_default=False)
