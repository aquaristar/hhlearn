...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CoreUserAssignments'
        db.create_table('core_user_assignments', (
        ...
        db.send_create_signal(u'dashboard', ['CoreUserAssignments'])


    def backwards(self, orm):
        # Deleting model 'CoreUserAssignments'
        db.delete_table('core_user_assignments')
