...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoreCurriculums.is_active'
        db.add_column('core_curriculums', 'is_active',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CoreCurriculums.is_active'
        db.delete_column('core_curriculums', 'is_active')
