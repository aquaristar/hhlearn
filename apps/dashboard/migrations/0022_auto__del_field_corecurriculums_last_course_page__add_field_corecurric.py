...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CoreCurriculums.last_course_page'
        db.delete_column('core_curriculums', 'last_course_page')

        # Adding field 'CoreCurriculums.resume_from_page'
        db.add_column('core_curriculums', 'resume_from_page',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CoreCurriculums.last_course_page'
        db.add_column('core_curriculums', 'last_course_page',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'CoreCurriculums.resume_from_page'
        db.delete_column('core_curriculums', 'resume_from_page')
