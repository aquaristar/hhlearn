...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CoreSafetyCurriculums'
        db.create_table('core_safety_curriculums', (
        ...
        db.send_create_signal(u'dashboard', ['CoreSafetyCurriculums'])

        # Adding M2M table for field safety_curriculums on 'CoreJobTitles'
        m2m_table_name = db.shorten_name('core_job_titles_safety_curriculums')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('corejobtitles', models.ForeignKey(orm[u'dashboard.corejobtitles'], null=False)),
            ('coresafetycurriculums', models.ForeignKey(orm[u'dashboard.coresafetycurriculums'], null=False))
        ))
        db.create_unique(m2m_table_name, ['corejobtitles_id', 'coresafetycurriculums_id'])


    def backwards(self, orm):
        # Deleting model 'CoreSafetyCurriculums'
        db.delete_table('core_safety_curriculums')

        # Removing M2M table for field safety_curriculums on 'CoreJobTitles'
        db.delete_table(db.shorten_name('core_job_titles_safety_curriculums'))
